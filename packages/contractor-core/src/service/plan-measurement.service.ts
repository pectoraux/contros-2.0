...
export class PlanMeasurementService {
  ...
  async createMeasurement(
    ...
    const pm = planMeasurement({
      ...
      quantity: { __brand: 'Quantity', value: quantityValue, unit: quantityUnit } as PlanMeasurement['quantity'],
  ...
  async getMeasurement(ctx: TenantContext, measurementId: string): Promise<PlanMeasurement> {
  ...
  async listMeasurements(ctx: TenantContext, projectId: string): Promise<PlanMeasurement[]> {
    requirePermission(ctx, 'plan:read')
