 ...
 *   - createDraft: payload + hash + revision are atomically persisted
 *   - updateDraft: only draft revisions can be updated
 *   - finalize: hash verification before finalization (defense in depth)
 *   - supersede: only finalized → superseded
